...
public class IGNCartoControllerTest {
    ...
    public void laGeometrieDoitRetournerUnePartition() {
        ...
        String geoJSON = "{\"type\":\"MultiPolygon\",\"coordinates\":[[[[2.2018004,48.9168055],[2.2016485,48.9167433],[2.2015624,48.916708],[2.2013932,48.9166386],[2.2012002,48.9165598],[2.2011225," +
                         "48.916528],[2.2009813,48.91647],[2.2007657,48.9163807],[2.2007283,48.9163646],[2.2005021,48.9162722],[2.2004168,48.9162372],[2.200313,48.9161947],[2.200239,48.916164],[2" +
    ...
    public void laGeometrieDoitRetournerUnIdGaspar() {
        ...
        String geoJSON = "{\"type\":\"MultiPolygon\",\"coordinates\":[[[[2.2018004,48.9168055],[2.2016485,48.9167433],[2.2015624,48.916708],[2.2013932,48.9166386],[2.2012002,48.9165598],[2.2011225," +
                         ...
                         ".915465],[2.1995168,48.9152836],[2.1997737,48.9153923],[2.2000942,48.9155275],[2.2002344,48.9155869],[2.2003995,48.9156549],[2.2021626,48.9163965],[2.2021485,48.9164128]," +
                         "[2.2021098,48.9164583],[2.2018004,48.9168055]]]]}";
        String partition = "130012073_SUP_78_PM1";
        ...
        assertThat(generateurFeatures.getFeatures()).anyMatch(generateur -> generateur.getProperties().getId_gaspar().equals("78DDT20100014"));
    }
}