            ...
            <div class="container bordered"
                ...
                <div>
                    ...
                    <p>Le bien est sur une parcelle concernée par un ou plusieurs plans de prévention des risques (PPR). Il peut être concerné par l’obligation de réaliser certains travaux. Vous devez
                       consulter le PPR auprès de la commune ou sur le site de la préfecture afin de vous assurer de cela. S’il existe des prescriptions de travaux, il est nécessaire de préciser si
                       les travaux ont été
