            ...
            <div class="panel clearfix">
                ...
                <div id="avis">
                    ...
                    <div id="conclusion0"
                         ...
                         v-if="conclusion === 0">
                        <p>Au regard de ces éléments, le propriétaire ou le bailleur n'est tenu à aucune obligation réglementaire en terme d'information acquéreur locataire au titre des pollutions de
                           sols
                    ...
                    <div id="conclusion1"
                         style="text-align: justify"
                         v-if="conclusion === 1">
                        <p>En cas de vente, le propriétaire est donc tenu de communiquer ces informations à l'acquéreur ou au locataire conformément à la réglementation en vigueur (article L. 514-20
                           du code
                        ...
                        <p>En outre, compte tenu de ce qui précède, nous recommandons, en cas de changement d'usage du terrain (travaux, constructions, ou changement de destination du bien), la
                           réalisation
                           d'une étude historique ou d'un diagnostic de sols dans un souci d'une meilleure prise en compte d'éventuelles pollutions. Nous vous rappelons que l'obligation de faire appel
                           à un
                           bureau d'étude certifié (ou équivalent) dans le domaine des sites et sols pollués conformément à la norme NF X 31-620 ne concerne que les attestations prévues aux articles
                           L. 556-1
                    ...
                    <section class="section section-white"
                        ...
                        <div class="section_content"
                            ...
                            <template v-if="avis.installationClasseeCommune.numberOf > 0"><p>Enfin, nous avons trouvé {{ avis.installationClasseeCommune.numberOf }} installation(s) classée(s) non
                                                                                             géoréférencées
