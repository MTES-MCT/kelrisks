...
public interface InstallationClasseeRepository extends IAbstractRepository<InstallationClassee> {
    ...
    @Query(value = "SELECT ic " +
                   ...
                   "       (ic.geocoded_score > 0.75 AND st_within(ic.geocoded_geog, polygon)) ", nativeQuery = true)
    ...
    @Query(value = "SELECT ic " +
                   ...
                   "       (ic.geocoded_score > 0.75 AND st_dwithin(ic.geocoded_geog, centroide, :distance))", nativeQuery = true)
    ...
    @Query(value = "SELECT * " +
                   ...
                   "       (ic.geocoded_score > 0.75 AND st_within(ic.geocoded_geog, :multiPolygon))", nativeQuery = true)
    ...
    @Query(value = "SELECT * " +
                   ...
                   "       (ic.geocoded_score > 0.75 AND st_within(ic.geocoded_geog, st_union(:multiPolygon)))", nativeQuery = true)
